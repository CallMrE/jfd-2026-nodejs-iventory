...
app.get("/registrasi", c_auth.form_registrasi);
app.get("/login", c_auth.form_login);
app.get("/logout", c_auth.logout);
app.post("/proses-registrasi", c_auth.proses_registrasi);
...
app.get("/produk/hapus/:id_pro", cek_login, c_master_produk.hapus);
app.get("/produk/create", cek_login, c_master_produk.form_tambah);
app.post(
  "/produk/update/:id_pro",
  cek_login,
  c_master_produk.validasi_insertProduk,
  c_master_produk.proses_update,
);
app.post(
  "/produk/insert",
  cek_login,
  c_master_produk.validasi_insertProduk,
  c_master_produk.insert,
);
...
app.post(
  "/stok-masuk/insert",
  cek_login,
  c_stok_masuk.validasi_stok_masuk,
  c_stok_masuk.insert,
);
...
app.post(
  "/stok-keluar/insert",
  cek_login,
  c_stok_keluar.validasi_stok_keluar,
  c_stok_keluar.insert,
);
